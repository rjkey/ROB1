...
image = cv2.imread('redblue.jpg')
output = image.copy()

boundaries = [
	([0,50,50],[10,255,255]),
	#([90,50,50],[110,255,255])
...
circles = cv2.HoughCircles(gray, cv.CV_HOUGH_GRADIENT, 1, 70, param1=100, param2=30, minRadius=40, maxRadius=95)
